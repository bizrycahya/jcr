...
export const NAV_ITEMS: Record<Role, NavItem[]> = {
  SUPER_ADMIN: [
    ...
    { label: "Manajemen User", href: "/dashboard/super-admin/manajemen-user", icon: Users },
    { label: "Data Guru", href: "/dashboard/super-admin/guru", icon: UserSquare2 },
    { label: "Penugasan Mengajar", href: "/dashboard/super-admin/penugasan-mapel", icon: BookOpen },
    ...
    { label: "Laporan Semester", href: "/dashboard/super-admin/laporan-semester", icon: CalendarRange },
  ...
  GURU: [
    ...
    { label: "Penilaian Karakter", href: "/dashboard/guru/penilaian-karakter", icon: ClipboardList },
    { label: "Riwayat Penilaian", href: "/dashboard/guru/riwayat-penilaian", icon: BookOpenText },

    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text>{data.notes?.trim() ? data.notes : '-'}</Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Tindak Lanjut</Text>
          <Text>{data.followUp?.trim() ? data.followUp : '-'}</Text>
        </View>
      </Page>
    </Document>
  );
